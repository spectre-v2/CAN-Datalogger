...
void can0_callback(){
    ...
    MCP_C1FIFOCON_t temp_c1fifocon;
    mcp_read_reg(MCP_REG_C1FIFOCON1, temp_c1fifocon.data_array, sizeof temp_c1fifocon.data_array);
    temp_c1fifocon.bits.UINC= 1;
    mcp_write_reg(MCP_REG_C1FIFOCON1, temp_c1fifocon.data_array, sizeof temp_c1fifocon.data_array);
