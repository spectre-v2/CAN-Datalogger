...
csv_log_entry new_csv_entry_buffer;
can_message_object_t can_message_buffer;
...
void sd_mount(){
    ...
    // write header
    f_write(&sd_card_logfile, sd_card_logfile_header, sizeof sd_card_logfile_header -1, &fatfs_bytes_written);
